...
import { ApiExtraModels, ApiOkResponse, ApiQuery, ApiSecurity, ApiTags } from '@nestjs/swagger'
...
import { AuditEventResponseDto, ListAuditEventsResponseDto } from './dtos/list-events.dto'

@UseGuards(ApiKeyGuard)
@ApiSecurity('x-api-key')
@ApiTags('audit')
@ApiExtraModels(AuditEventResponseDto, ListAuditEventsResponseDto)
...
export class ListEventsController {
	...
	async handle(@Query() query: ListAuditEventsDto): Promise<ListAuditEventsResponseDto> {
